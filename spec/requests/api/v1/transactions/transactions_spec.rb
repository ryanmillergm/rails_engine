...
describe "Transactions API" do
  it "returns a list of all transactions" do
    ...
    transaction_2 = Transaction.create(invoice_id: invoice_1.id, credit_card_number: "23432343234232234", credit_card_expiration_date: "01102020", result: "success")
    transaction_3 = Transaction.create(invoice_id: invoice_2.id, credit_card_number: "23432343234232234", credit_card_expiration_date: "01102020", result: "success")
    transaction_4 = Transaction.create(invoice_id: invoice_2.id, credit_card_number: "23432343234232234", credit_card_expiration_date: "01102020", result: "success")
    transaction_5 = Transaction.create(invoice_id: invoice_2.id, credit_card_number: "23432343234232234", credit_card_expiration_date: "01102020", result: "success")
